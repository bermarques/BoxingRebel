...
import br.com.boxingrebel.ecom.product.domain.aggregate.ProductBuilder;
import br.com.boxingrebel.ecom.product.domain.vo.*;
...
public class RestProduct {
  ...
  public RestProduct(String brand, String color, String description, String name,
                     double price, ProductSize size, RestCategory category, boolean featured,
