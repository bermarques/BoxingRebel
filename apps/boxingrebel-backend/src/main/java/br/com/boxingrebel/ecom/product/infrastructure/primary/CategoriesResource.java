...
import br.com.boxingrebel.ecom.product.application.ProductsApplicationService;
...
import static br.com.boxingrebel.ecom.product.infrastructure.primary.ProductsAdminResource.ROLE_ADMIN;
...
public class CategoriesResource {
  ...
  public ResponseEntity<Page<RestCategory>> findAll(Pageable pageable) {
    ...
    PageImpl<RestCategory> restCategories = new PageImpl<>(
      categories.getContent().stream().map(RestCategory::fromDomain).collect(Collectors.toList()),
      pageable,
